 ...
 * github.com/rowlandshepard/iro.js
 */
...
(function (global, factory) {
    ...
    if (
      ...
      "o" === l[0] && "n" === l[1]
        ? ((e = l !== (l = l.replace(/Capture$/, ""))),
          ...
          u
            ? (t || n.addEventListener(l, T, e), ((n.t || (n.t = {}))[l] = u))
        ...
        if (
          ...
          null != N.getDerivedStateFromProps &&
            s(
              ...
              N.getDerivedStateFromProps(_, v.__s)
            ),
          p)
        ) {
          null == N.getDerivedStateFromProps &&
          ...
          if (
            ...
            !e &&
              ...
              !1 === v.shouldComponentUpdate(_, v.__s, P))
          ) {
            for (
              v.props = _,
                v.state = v.__s,
                v.__d = !1,
                v.__v = u,
                u.__e = null != c ? (c !== t.__e ? c : t.__e) : null,
                u.__k = t.__k,
                h = 0;
              h < u.__k.length;
              h++
  ...
  (n = {}),
    (m.prototype.setState = function (n, l) {
      ...
      ("function" != typeof n || (n = n(u, this.props))) && s(u, n),
        null != n &&
          this.__v &&
          ((this.u = !1), l && this.__h.push(l), k(this));
    }),
  ...
  var PERMISSIVE_MATCH_4 =
    ...
    ")[,|\\s]+(" +
    CSS_UNIT +
    ")\\s*\\)?"; // Regex patterns for functional color strings
  ...
  var IroColor =
    ...
    (function () {
      ...
      _proto.setChannel = function setChannel(format, channel, value) {
        ...
        this[format] = _extends(
          {},
          this[format],
          ((_extends2 = {}), (_extends2[channel] = value), _extends2)
        );
      };
      /**
  ...
  function getSliderDimensions(props) {
    ...
    sliderSize =
      (_sliderSize = sliderSize) != null
        ? _sliderSize
        : padding * 2 + handleRadius * 2;
  ...
  function getCurrentSliderValue(props, color) {
    ...
    switch (props.sliderType) {
      ...
      case "kelvin":
        ...
        var percent =
          ((color.kelvin - minTemperature) / temperatureRange) * 100; // clmap percentage
  ...
  function getSliderGradient(props, color) {
    ...
    switch (props.sliderType) {
      ...
      case "kelvin":
        ...
        for (
          var kelvin = min, stop = 0;
          kelvin < max;
          kelvin += range / numStops, stop += 1
        ) {
  ...
  function getHandleRange(props) {
    return (
      props.width / 2 - props.padding - props.handleRadius - props.borderWidth
    );
  }
  /**
   ...
   * https://github.com/rowlandshepard/iro.js/issues/18
   * https://github.com/rowlandshepard/iro.js/issues/45
   * https://github.com/rowlandshepard/iro.js/pull/89
  ...
  var IroComponentWrapper = /*@__PURE__*/ (function (Component) {
    ...
    IroComponentWrapper.prototype = Object.create(
    ...
    return h(
      "svg",
      {
        ...
        style: {
          ...
          transform:
            "translate(" + cssValue(props.x) + ", " + cssValue(props.y) + ")",
      ...
      url &&
        h("use", Object.assign({ xlinkHref: resolveSvgUrl(url) }, props.props)),
      !url &&
        h("circle", {
          cx: cx,
          cy: cy,
  ...
  function IroSlider(props) {
    ...
    var activeColor =
      activeIndex !== undefined && activeIndex < props.colors.length
        ? props.colors[activeIndex]
        : props.color;
    ...
    return h(
      IroComponentWrapper,
      Object.assign({}, props, { onInput: handleInput }),
      ...
      function (uid, rootProps, rootStyles) {
        return h(
          ...
          h("div", {
            ...
            style: Object.assign(
              {},
              { width: "100%", height: "100%", borderRadius: cssValue(radius) },
              cssBorderStyles(props),
              {
                background:
  ...
  var HUE_GRADIENT_CLOCKWISE =
    "conic-gradient(red, yellow, lime, aqua, blue, magenta, red)";
  var HUE_GRADIENT_ANTICLOCKWISE =
        ...
        return h(
          ...
          h("div", {
            ...
            style: Object.assign({}, circleStyles, {
              ...
              background:
                props.wheelDirection === "clockwise"
  ...
  var IroColorPicker = /*@__PURE__*/ (function (Component) {
     ...
     */
    IroColorPicker.prototype.setColors = function setColors(
      newColorValues,
      activeColorIndex
    ) {
      var this$1 = this;
    ...
    IroColorPicker.prototype.on = function on(eventList, callback) {
      ...
      (!Array.isArray(eventList) ? [eventList] : eventList).forEach(function (
        eventType
      ) {
        // Add event callback
    ...
    IroColorPicker.prototype.deferredEmit = function deferredEmit(eventType) {
      ...
      (deferredEvents[eventType] || (deferredEvents[eventType] = [])).push(
        args
      );
    };
     ...
     */
    IroColorPicker.prototype.onColorChange = function onColorChange(
      color,
      changes
    ) {
      this.setState({ color: this.color });
     ...
     */
    IroColorPicker.prototype.emitInputEvent = function emitInputEvent(
      type,
      originId
    ) {
      if (type === 0 /* Start */) {
