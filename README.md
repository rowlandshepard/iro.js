<h1 align="center"><a href="//rowlandshepard.dev" target="blank"><img height="340" src="https://raw.githubusercontent.com/rowlandshepard/iro.js/master/assets/screenshot.png"/><br/>iro.js</a></h1>

<p align="center">
  <b>Modular, design-conscious color picker widget for JavaScript - with support for a bunch of color formats | <a href="//rowlandshepard.dev" target="blank">rowlandshepard.dev</a></b>
</p>

<p align="center">
  <a href="https://github.com/rowlandshepard/iro.js/blob/master/LICENSE.txt">
    <img src="https://badgen.net/github/license/rowlandshepard/iro.js?color=BB5FD1" alt="license" />
  </a>
  <a href="https://npmjs.org/package/@rowlandshepard/iro">
    <img src="https://badgen.net/npm/v/@rowlandshepard/iro?color=6C8FF2" alt="version" />
  </a>
  <a href="https://npmjs.org/package/@rowlandshepard/iro">
    <img src="https://badgen.net/npm/dt/@rowlandshepard/iro?color=6AD4E0" alt="downloads" />
  </a>
  <a href="https://bundlephobia.com/result?p=@rowlandshepard/iro">
    <img src="https://badgen.net/bundlephobia/minzip/@rowlandshepard/iro?color=6FDF89" alt="minzip size" />
  </a>
  <a href="">
...
<p align="center">
  <a href="#features">Features</a> | <a href="#codepen-demos">Demo</a> | <a href="#installation">Installation</a> | <a href="#usage">Usage</a> | <a href="https://rowlandshepard.dev/guide.html">Documentation</a> | <a href="#special-thanks">Special Thanks</a> | <a href="https://github.com/rowlandshepard/iro.js/discussions">Forum</a>
</p>
...
- [~9kb](https://bundlephobia.com/result?p=@rowlandshepard/iro) minified and gzipped
- Licenced under MPL 2.0 - 100% free for personal and commercial use

<img height="16" height="888" src="https://raw.githubusercontent.com/rowlandshepard/iro.js/master/assets/break.png"/>
...
<tr ><td class="option-td td_text"><code>color</code></td><td class="purpose-td td_text">The initial color value. This can be any [supported color format](https://rowlandshepard.dev/color_api.html#supported-color-formats).</td><td class="default-value-td td_text"><code>#ffffff</code></td></tr>
<tr ><td class="option-td td_text"><code>colors</code></td><td class="purpose-td td_text">Initial color values used for [multi-color selections](https://rowlandshepard.dev/advanced.html#multi-color-selections).</td><td class="default-value-td td_text">null</td></tr>
...
<tr ><td class="option-td td_text"><code>layout</code></td><td class="purpose-td td_text">Used for customising the [UI component layout](https://rowlandshepard.dev/advanced.html#custom-ui-layouts).</td><td class="default-value-td td_text"><code>null</code></td></tr>
...
<tr ><td class="option-td td_text"><code>handleSvg</code></td><td class="purpose-td td_text">Custom handle SVG, used for [custom handles](https://rowlandshepard.dev/advanced.html#custom-handles).</td><td class="default-value-td td_text"><code>null</code></td></tr>
<tr ><td class="option-td td_text"><code>handleProps</code></td><td class="purpose-td td_text">Custom handle properties, used for [custom handles](https://rowlandshepard.dev/advanced.html#custom-handles).</td><td class="default-value-td td_text"><code>{x:0, y:0}</code></td></tr>
...
More details about color picker options, properties, and methods can be found on the [colorPicker API documentation](https://rowlandshepard.dev/colorPicker_api.html).
...
For more details about color objects, check out the [Color API documentation](https://rowlandshepard.dev/color_api.html).
...
The color picker's [`on`](https://rowlandshepard.dev/colorPicker_api.html#on) method can be used to attach functions that will be called whenever a particular event is fired. In this example, we add a listener for the `color:change` event:
...
The [`on`](https://rowlandshepard.dev/colorPicker_api.html#on) method can also take an array of event names, in case you want to listen to multiple events with one function:
...
Event listeners can also be removed at any time by passing the same function to the color picker's [`off`](https://rowlandshepard.dev/colorPicker_api.html#off) method:
